...
export function PhilosophyStrip({ locale }: { locale: Locale }) {
  ...
  const phrase =
    locale === "es"
      ? "El Elements Method devuelve a los ejecutivos a su fuente instintiva de poder. A través de experiencias inmersivas en entornos naturales, los líderes descubren las cuatro fuerzas fundamentales que moldean el liderazgo resiliente, auténtico y efectivo — y aprenden a integrarlas en su propio núcleo."
      : "The Elements Method brings executives back to their instinctive source of power. Through immersive experiences in natural environments, leaders discover the four fundamental forces that shape resilient, authentic, and effective leadership — and learn to integrate them in their own core.";
