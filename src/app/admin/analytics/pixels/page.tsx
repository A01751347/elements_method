...
export default async function AdminPixelsPage({
  ...
  return (
    <div className="flex flex-col gap-8">
      <PageHeader
        title="Pixels y etiquetas"
        subtitle="IDs de Google Analytics, Meta, Ads y LinkedIn. Se aplican de inmediato y solo se cargan con el consentimiento de cookies del visitante. Son opcionales: el panel de tráfico funciona sin ellos."
        actions={
          <>
            <Boton tone="secundario" href="/admin/analytics">
              Ver tráfico
            </Boton>
