...
export const calendarRetreats: CalendarRetreat[] = [
  ...
  },
  {
    ...
    "venueLabelEn": "TBD",
    "venueNote": "Sede en proceso de selección",
    "summaryEs": "El retiro de cierre nos invita a volver al núcleo: ese lugar dentro de ti donde se revisa el año, se nombra lo vivido y se suelta lo que ya no viene contigo. Tres días para integrar 2026 con presencia, silencio y una despedida consciente antes de abrir el siguiente capítulo.",
    "summaryEn": "The closing retreat invites us back to the core: that place inside you where the year is reviewed, what was lived is named and what no longer belongs is released. Three days to integrate 2026 with presence, silence and a conscious farewell before the next chapter opens.",
    "status": "open",
    "capacity": 15,
    "seatsLeft": 14,
    "investmentLabelEs": "Inversión a confirmar",
