...
export const calendarRetreats: CalendarRetreat[] = [
  ...
  // Las landings completas viven en src/data/experiences.ts (mismo slug).
  {
    ...
    endDate: "2026-10-08",
    dateLabelEs: "Jueves 8 de octubre de 2026 · 9:00–19:00",
    dateLabelEn: "Thursday, October 8, 2026 · 9:00–19:00",
    venueState: "tbd",
    ...
    capacity: 20,
    seatsLeft: 20,
    investmentLabelEs: "$7,500 MXN · Early Access $5,900 hasta el 30 de septiembre",
    investmentLabelEn: "MX$7,500 · Early Access MX$5,900 through Sep 30",
    isPlaceholder: true,
